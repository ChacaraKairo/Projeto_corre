...
export default function MainCalculadoraFlex() {
  ...
  const calcularVantagem = () => {
    ...
    if (!alc || !gas || isNaN(alc) || isNaN(gas)) return null;
      ...
      >
        ...
        <View style={styles.inputsSection}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={[styles.inputWrapper, styles.inputWrapperGas]}>
        ...
        {resultado ? (
          ...
          >
            ...
            >
              {resultado.compensaEtanol ? "Etanol" : "Gasolina"}
            </Text>
            ...
            <View style={styles.resultStats}>
              <View style={styles.resultStat}>
                <Text style={styles.resultStatLabel}>Rendimento</Text>
                <Text
                  style={[
              ...
              <View style={styles.resultStat}>
                <Text style={styles.resultStatLabel}>Limite Etanol</Text>
                <Text style={[styles.resultStatValue, { color: "#fff" }]}>
          ...
          <View style={styles.emptyCard}>
            <FontAwesome5 name="gas-pump" size={40} color="#1A1A1A" />
        ...
        <View style={styles.infoBox}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.infoTitle}>Cálculo Atualizado</Text>
            <Text style={styles.infoText}>
              O ponto de viragem agora é de{" "}
              <Text style={styles.infoHighlight}>75%</Text>. Se o álcool custar
              menos de 75% da gasolina, ele é financeiramente superior para
              motores modernos e para a nova mistura E30.
            </Text>
          </View>
        </View>
      </ScrollView>
